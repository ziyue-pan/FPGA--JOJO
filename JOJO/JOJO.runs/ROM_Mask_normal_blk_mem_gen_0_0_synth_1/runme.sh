...
HD_PWD='C:/Users/Raymond-Ziyue/Desktop/JOJO/JOJO.runs/ROM_Mask_normal_blk_mem_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ROM_Mask_normal_blk_mem_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ROM_Mask_normal_blk_mem_gen_0_0.tcl
